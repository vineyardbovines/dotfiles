...
- Terminal: [Wezterm](https://wezterm.org/) using zsh w/ [starship prompt](https://starship.rs/) and [color-ls](https://github.com/athityakumar/colorls)
...
This expands to [run.sh](https://github.com/vineyardbovines/dotfiles/blob/master/run.sh) which will fetch this repo and run the install script.
